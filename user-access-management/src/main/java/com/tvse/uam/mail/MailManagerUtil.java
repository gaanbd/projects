...
import com.tvse.uam.repository.EmailConfigurationRepository;
import com.tvse.uam.repository.EmailSettingsRepository;
...
public class MailManagerUtil {
	...
	private void sendHtmlMail(String emailId, Map<String, Object> metaEmailContent,
